      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10, marginBottom: '1.75rem' }}>
          <div style={{
            ...
            <Flower2 size={26} style={{ color: 'var(--pink)' }} />
          </div>
          <div style={{ textAlign: 'center' }}>
            <h1 style={{ margin: 0, color: 'var(--pink)', fontSize: '1.3rem', fontWeight: 800 }}>Bienvenida</h1>
            <p style={{ margin: '2px 0 0', color: 'var(--muted)', fontSize: '0.82rem', fontWeight: 500 }}>
        ...
        <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            <label style={{ color: 'var(--pink)', fontSize: '0.85rem', fontWeight: 600 }}>Usuario</label>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            <label style={{ color: 'var(--pink)', fontSize: '0.85rem', fontWeight: 600 }}>Contraseña</label>
